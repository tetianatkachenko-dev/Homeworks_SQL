...
CREATE INDEX idx_orders_total_amount ON orders(total_amount); -- Created because of usage this column in WHERE function.
CREATE INDEX idx_orders_customer ON orders(customer_id);  -- Created because of usage in JOIN.
CREATE INDEX idx_orders_product ON orders(product_id); -- Created because of usage in JOIN.
CREATE INDEX idx_orders_date ON orders(order_date); -- Created because of usage in ORDER BY function.
